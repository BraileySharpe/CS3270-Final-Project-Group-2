...
from Game.move_provider_tanh import ModelMinimaxProvider
from evaluation_model.mini_max_searcher import mini_max_searcher
from evaluation_model.mini_max_searcher_tanh import mini_max_searcher_tanh
...
if __name__ == "__main__":
    ...
    model = load_model("evaluation_cnn_model.pth", device) #TODO edit this

    stockfish = StockfishEvaluator(
        engine_path="C:/Users/matts/Desktop/stock/stockfish/stockfish-windows-x86-64-avx2.exe", ##TODO edit this
        depth=3
    )

    try:
        model_provider = ModelMinimaxProvider(
            searcher=mini_max_searcher_tanh,
            model=model,
            depth=3,
            max_moves=10
        )
